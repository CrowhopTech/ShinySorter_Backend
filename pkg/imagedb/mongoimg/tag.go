...
func (mc *mongoConnection) ListTags(ctx context.Context) ([]*imagedb.Tag, error) {
...
func (mc *mongoConnection) CreateTag(ctx context.Context, t *imagedb.Tag) (*imagedb.Tag, error) {
...
func (mc *mongoConnection) ModifyTag(ctx context.Context, t *imagedb.Tag) (*imagedb.Tag, error) {
	trueVal := true
