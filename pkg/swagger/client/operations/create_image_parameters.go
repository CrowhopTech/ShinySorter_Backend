...
// WithNewImage adds the newImage to the create image params
func (o *CreateImageParams) WithNewImage(newImage *models.Image) *CreateImageParams {
	o.SetNewImage(newImage)
	return o
}

// SetNewImage adds the newImage to the create image params
func (o *CreateImageParams) SetNewImage(newImage *models.Image) {
	o.NewImage = newImage
}
...
func (o *CreateImageParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	var res []error
	if o.NewImage != nil {
		if err := r.SetBodyParam(o.NewImage); err != nil {
			return err
		}
	}
