...
/* ListQuestionsParams contains all the parameters to send to the API endpoint
   for the list questions operation.
...
// WithDefaults hydrates default values in the list questions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListQuestionsParams) WithDefaults() *ListQuestionsParams {
	o.SetDefaults()
	return o
}

// SetDefaults hydrates default values in the list questions params (not the query body).
//
// All values with no default are reset to their zero value.
func (o *ListQuestionsParams) SetDefaults() {
